                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">বানী ও নোটিশ</a>
                    ...
                    <li class="nav-item">
                        <a href="{{ url('about-us') }}" class="nav-link {{ Request::is('about-us*') ? 'active' : ''}}">আমাদের
                            সম্পর্কে </a>
                    </li>
                    {{--                    <li class="nav-item dropdown">--}}
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            @foreach($area as $item)
                                <a class="dropdown-item"
                                   href="{{url('details-sapox/'.$item->id)}}">{{$item->name_bn}}</a>
                            @endforeach
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            @foreach($area as $item)
                                <a class="dropdown-item"
                                   href="{{url('details-ladiesclub/'.$item->id)}}">{{$item->name_bn}}</a>
                            @endforeach
                        </div>
                    </li>
                    {{--                    <li class="nav-item">--}}
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            @foreach($area as $item)
                                <a class="dropdown-item"
                                   href="{{url('details-childrenclub/'.$item->id)}}">{{$item->name_bn}}</a>
                            @endforeach
                        </div>
                    </li>
                    {{-- <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="{{ url('publication') }}"
                           class="nav-link {{ Request::is('publication*') ? 'active' : ''}}">প্রকাশনী</a>
                    </li>
                    {{--                    <li class="nav-item">--}}
                    ...
                    @auth
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link " href=""><i
                                    class="fa fa-user-circle-o"></i>&nbsp;@if(!empty(Auth::user()->name_bn)){{Auth::user()->name_bn}} @else {{Auth::user()->username}} @endif
                            </a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                @auth
                                    @if(Auth::user()->is_ladies_club_member==1)
                                        <a class="dropdown-item" href="{{route('app.member.dashboard')}}">ড্যাশবোর্ড</a>
                                    @else
...
{{--                                        <a class="dropdown-item" href="{{route('memberProfile.index')}}">প্রোফাইল</a>--}}
                                    @else
{{--                                        <a class="dropdown-item" href="{{url('user-profile')}}">প্রোফাইল</a>--}}
                                    @endif
                                    {{--                                @endif--}}
                                    ...
                                    <button type="button" tabindex="0" class="dropdown-item" onclick="event.preventDefault();
                                            ...
                                            class="fas fa-sign-out-alt"></i>&nbsp;লগআউট
                                    </button>

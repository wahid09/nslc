    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                ...
                <a href="{{ route('app.training.create') }}" class="btn-shadow mr-3 btn btn-primary" name="button">
                ...
                <div class="card-body">
                    <table style="width: 100%;" id="dataTable" class="table table-hover table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <th class="text-center">Trainning Date</th>
                        ...
                        @foreach ($trainnings as $trainning)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ route('app.training.edit', $trainning->id)}}" class="btn btn-primary"><i
                                            class="fas fa-edit"></i></a>
                                    @endpermission

                                    @permission('training-delete')
                                    <button onclick="deleteData({{$trainning->id}})" type="button"
                                            class="btn btn-danger"><i class="fas fa-trash"></i></button>
                                    <form id="delete-{{$trainning->id}}" method="POST"
                                          action="{{ route('app.training.destroy', $trainning->id) }}"
                                          style="display:none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>

    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                ...
                <a href="{{ route('app.notices.create') }}" class="btn-shadow mr-3 btn btn-primary" name="button">
                        ...
                        @foreach ($notices as $notice)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ route('app.notices.edit', $notice->id)}}" class="btn btn-primary"><i
                                            class="fas fa-edit"></i></a>
                                    @endpermission

                                    @permission('notice-index')
                                    <a href="{{ route('app.notices.show', $notice->id)}}" class="btn btn-primary"><i
                                    ...
                                    <form id="delete-{{$notice->id}}" method="POST"
                                          action="{{ route('app.notices.destroy', $notice->id) }}"
                                          style="display:none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>

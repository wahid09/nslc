...
">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="text-center">কেন্দ্রীয় কার্যালয়ের কাঠামো(চিলড্রেন ক্লাব)</h3>
...
">
    ...
    {{--                        <div class="col-md-12">--}}
    {{--                            <a class="area-work" data-fancybox="" data-caption="{{$program->title_bn}}" href="{{asset('storage/programs/'.$program->image)}}" style="background-image: url({{asset('storage/programs/'.$program->image)}}); width: 344px; height: 248px;">--}}
    ...
    {{--            <div class="row">--}}
    {{--                <div class="col-md-12 text-center">--}}
    {{--                    <h3>কেন্দ্রীয় প্রশিক্ষণ কর্মসূচি ক্যালেন্ডার(চিলড্রেন ক্লাব)</h3>--}}
    {{--                    <div id='calendar'></div>--}}
    {{--                </div>--}}
    ...
    <section style="margin-top: 30px;">
        <div class="container ccalendar">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3>সম্মানীত প্রধান পৃষ্টপোষকের কর্মসূচি ক্যালেন্ডার(চিলড্রেন ক্লাব)</h3>
    ...
    <section style=" background-color: #fdfbfb; padding: 40px 0;">
        <div class="container warea">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3 class="">কল্যাণমূলক কার্যক্রম(চিলড্রেন ক্লাব)</h3>
                </div>
                ...
                <div class="col-md-12 tab-parent children-tab">
                    @foreach($areas as $area)
                        <a href="{{url('details-childrenclub/'.$area->id)}}"
                           class="tab-btn @if ($loop->first) active cbgcolor @endif"> {{ $area->name_bn }}</a>
                    @endforeach
                </div>

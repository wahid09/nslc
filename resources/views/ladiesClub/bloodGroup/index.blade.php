    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                ...
                <a href="{{ route('app.blood-group.create') }}" class="btn-shadow mr-3 btn btn-primary" name="button">
                    <i class="fas fa-plus-circle"></i>&nbsp;Create Blood Group
                </a>
                @endpermission
            </div>
        </div>
                        ...
                        @foreach ($bloodGroups as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ route('app.blood-group.edit', $item->id)}}" class="btn btn-primary"><i
                                    ...
                                    <form id="delete-{{$item->id}}" method="POST"
                                          action="{{ route('app.blood-group.destroy', $item->id) }}" style="display:none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                    @endpermission

...
@section('content')
    <div class="app-page-title">
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                <a href="{{ route('app.ladies-club-notice.index') }}" class="btn-shadow mr-3 btn btn-warning" name="button">
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{ isset($notice) ? route('app.ladies-club-notice.update', $notice->id) : route('app.ladies-club-notice.store') }}"
                                ...
                                <div class="form-group notice">
                                    ...
                                    <select id="area"
                                        ...
                                        @foreach ($areas as $area)
                                            <option value="{{ $area->id}}" @isset($notice)
                                                {{($notice->area_id == $area->id) ? 'selected' : ''}}
                                                @endisset
                                            >{{ $area->name_bn}}</option>
                                        @endforeach
                                    </select>
